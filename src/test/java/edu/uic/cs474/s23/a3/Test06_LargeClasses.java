...
public class Test06_LargeClasses {
    ...
    public void test01() {
        ...
        sp22.addCourse(new Course(51234, "CS 473", 50));
        sp22.addCourse(new Course(51234, "CS 377", 90));
    ...
    public void testRandom() {
        ...
        for(int i = 0; i < 4; i++){
            s1.addCourse(new Course(r.nextInt(99999), generateRandomString(), r.nextInt(40)));
            s2.addCourse(new Course(r.nextInt(99999), generateRandomString(), r.nextInt(40)));
            s3.addCourse(new Course(r.nextInt(99999), generateRandomString(), r.nextInt(40)));
        }
